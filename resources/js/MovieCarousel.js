...
function getPromotionalMoviesJSON(){
	...
	if ((month === 2) && (day > 5) && (day <= 4))
		return "resources/data/promotional_movies/valentines.json";
	...
	// If the date is between Oct 15 - Oct 31, then display halloween movies.
		...
		return "resources/data/promotional_movies/halloween.json";
	// If the date is between Nov 17 - 28, then display thanksgiving movies
	else if ((month === 11) && (day > 16) && (day <=28))
		return "resources/data/promotional_movies/thanksgiving.json";
	else if (month === 12)
		return "resources/data/promotional_movies/holiday.json";

	//forth of july movies
	else {
		//Display promotional movies for that month
		return "resources/data/promotional_movies/summerfilms.json";
